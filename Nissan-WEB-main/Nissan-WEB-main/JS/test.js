    ...
    async Download(targetElement) {
      ...
      if (records) {
        const input_html = records
          .map((e) =>
            queryString
              ? modelName === e.modelName   //shalgah gj bga uildel ? vildel vnen baival hiih zuils : uildel hudal baiwal hiih zuils
          ...
          // document.getElementById('mycars).insertAdjacentHTML('mycarsiin haana ni bailgah bairlal', ter bairlald hiih gj baigaa html) 
